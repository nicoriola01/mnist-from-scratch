import numpy as np
from src.data_loader import labels_train, data_train, data_test, labels_test
...
def gradient_descent(data, labels):
    ...
    for epoch in range(epochs):
        ...
        data_train_shuffle = data[:, shuffle]
        labels_train_shuffle = labels[shuffle]
        ...
        _,_,_,current_prediction_train = forward_propagation(data, W1, b1, W2, b2)
        train_accuracy = calculate_accuracy(current_prediction_train, labels)
        ...
        training_loss = calculate_loss(current_prediction_train, labels)
